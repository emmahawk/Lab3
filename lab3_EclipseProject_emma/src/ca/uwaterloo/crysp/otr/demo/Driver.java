...
public class Driver {
	...
	public static boolean isBob=false;
	public static boolean isAlice=false;
	public static boolean firstTime=true;
	public static boolean questionSet=false;
...
class SendingThread extends Thread{
	...
	public void run(){
		...
		while(true){
			try {
				if(Driver.isAlice==true && Driver.firstTime==true)
				{
					str="start";
					...
					boolean secure=Driver.isSecure;
					while(!secure)
					{
						secure=Driver.isSecure;
				...
				else if(Driver.isBob==true && Driver.firstTime==true)
				{
//					str="start";
//					System.out.println("To OTR:"+str.length()+": "+str);
//					OTRTLV[] tlvs = new OTRTLV[1];
...
class LocalCallback implements OTRCallbacks{
	...
	public void goneSecure(OTRContext context) {
		...
		System.out.println("MAKE succeeded/yes");
		Driver.isSecure=true;
	}
