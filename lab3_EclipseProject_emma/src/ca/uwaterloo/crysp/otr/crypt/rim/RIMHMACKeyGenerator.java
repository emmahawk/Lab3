 ...
 */
public class RIMHMACKeyGenerator extends
        ca.uwaterloo.crysp.otr.crypt.HMACKeyGenerator {

    public Key generateKey() throws OTRCryptException {
        byte[] keyData = RandomSource.getBytes(1024);
        return new RIMHMACKey(keyData);
    }
}
